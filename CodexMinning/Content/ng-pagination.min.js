                    ...
                    function (t) {
                        return {
                            link: function (n, a, g) {
                                ...
                                function i() {
                                    var e, t, a; if (n.pagenums = [], 0 !== n.pageCount)
                                        for (n.currentPage > n.pageCount && (n.currentPage = 1), n.pageCount <= o ? (e = 1, t = n.pageCount) : (a = Math.ceil(o / 2), e = Math.max(n.currentPage - a, 1), t = Math.min(e + o - 1, n.pageCount), n.pageCount - t < a && (e = t - o + 1)); e <= t; e++)n.pagenums.push(e)
                                }
                                var o = e.isDefined(g.visiblePageCount) ? ~~g.visiblePageCount
                                    || t.visiblePageCount : t.visiblePageCount;
                                n.firstText = e.isDefined(g.firstText) ? g.firstText : t.firstText,
                                    ...
                                    n.currentPage = 1, n.pageChange = function (e) { e >= 1 && e <= n.pageCount ? n.currentPage = e : n.currentPage = 1 },
                                    n.keyupHanlder = function (e) {
                                        var t = e.target.value, a = parseInt(t, 10);
                                        if (Number.isNaN(a)) {
                                            if (!e.preventDefault) return !1; e.preventDefault()
                                        } else a >= 1 && a <= n.pageCount || (a < 1 ? e.target.value = 1 : e.target.value = n.pageCount),
