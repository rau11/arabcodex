app.controller('addEditTestController ', ['$scope', '$filter', '$compile', 'masterconfigurationService', 'toaster', '$uibModal', '$uibModalInstance', 'ParamObject', function ($scope, $filter, $compile, masterconfigurationService, toaster, $uibModal, $uibModalInstance, ParamObject) {
